<template>
  <div id="app" class="contain">
    <GamestateStart v-if="uiState === 'start'">
      ...
      <button @click="pickCharacter">Pick</button>
    </GamestateStart>
    <GamestateFinish v-else-if="uiState === 'lost' || uiState === 'won'">
    </GamestateFinish>
    <section v-else>
...
import Artist from "@/components/ArtistComponent.vue";
import Baker from "@/components/BakerComponent.vue";
import Zombie from "@/components/ZombieComponent.vue";
import Mechanic from "@/components/MechanicComponent.vue";
